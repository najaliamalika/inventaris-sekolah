<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div
            ...
            <div class="flex items-center justify-between mb-2">
                <p class="text-xs font-medium text-orange-600 dark:text-orange-400">Total Barang Keluar</p>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                ...
                                <td class="px-4 py-4">
                                    <span
                                        ...
                                        @if ($item->kategori == 'habis_pakai') bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400
                                        @elseif($item->kategori == 'rusak') bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400
