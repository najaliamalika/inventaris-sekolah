    ...
    @push('scripts')
        <script>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="harga_satuan[]" min="0" value="${harga}"
                            inputmode="numeric"
            ...
            existingDetails.forEach((detail, index) => {
                ...
                const hargaInput = detailElement.querySelector('[data-format-number="true"]');
                if (hargaInput) {
            ...
            const form = document.getElementById('update_barang_masuk');
