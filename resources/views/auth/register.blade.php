<x-guest-layout>
    <div
        class="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-indigo-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md">
            <!-- Logo/Header Section -->
            <div class="text-center mb-10">
                <div
                    class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-green-600 to-green-400 shadow-lg mb-6">
                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('register') }}" class="space-y-6">
                        ...
                        <div class="group">
                            ...
                            <p class="text-xs text-gray-500 mt-2">Gunakan kombinasi huruf besar, huruf kecil, angka dan
                                simbol</p>
                        </div>
                ...
                <div class="px-8 py-6 bg-gray-50 border-t border-gray-100">
                    <p class="text-center text-xs text-gray-600">
                        Dengan mendaftar, Anda menyetujui <a href="#"
                            class="text-green-600 hover:text-green-700">Syarat & Ketentuan</a> kami
                    </p>
                </div>
            </div>
