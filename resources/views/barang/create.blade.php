    ...
    <x-slot name="header">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">
                @if ($jenisBarang)
                    Tambahkan barang dengan kategori: <span
    ...
    <div
        ...
        @if ($jenisBarang)
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Kategori Terpilih</p>
        ...
        <div class="p-8">
            <form id="create_item" method="POST" action="{{ route('barang.store') }}" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="group">
                        ...
                        <x-text-input id="kode_barang"
                            ...
                            :value="old('kode_barang')" autocomplete="kode_barang" />
                    ...
                    <div class="relative">
                        <label
                            ...
                            <span id="fileName" class="text-gray-500 dark:text-gray-400 text-sm font-medium">
                                📷 Pilih file gambar (jpg, jpeg, png - Max 2MB)
                            </span>
                ...
                <x-confirm-modal id="save_confirmation" message="Apakah Anda yakin ingin menyimpan barang ini?"
                    okLabel="Simpan" cancelLabel="Batal" :url="route('barang.store')" formId="create_item" />
            </form>
        </div>
    </div>
